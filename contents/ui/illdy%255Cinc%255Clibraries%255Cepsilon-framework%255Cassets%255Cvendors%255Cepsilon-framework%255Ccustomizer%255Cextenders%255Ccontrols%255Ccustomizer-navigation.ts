...
<script type='text/javascript' src='contents/ui/theme/layout/js/pace/pace.min.js'></script>
<script type='text/javascript'>
/* <![CDATA[ */
var userSettings = {"url":"\/wordpress\/","uid":"0","time":"1537564596","secure":""};
/* ]]> */
</script>
<script type='text/javascript' src='inc/js/utils.min.js'></script>
<script type='text/javascript' src='inc/js/plupload/moxie.min.js'></script>
<script type='text/javascript' src='inc/js/plupload/plupload.min.js'></script>
<!--[if lt IE 8]>
...
<script type='text/javascript' src='inc/js/mediaelement/mediaelement-and-player.min.js'></script>
<script type='text/javascript' src='inc/js/mediaelement/mediaelement-migrate.min.js'></script>
<script type='text/javascript'>
/* <![CDATA[ */
var _wpmejsSettings = {"pluginPath":"\/wordpress\/inc\/js\/mediaelement\/","classPrefix":"mejs-","stretching":"responsive"};
/* ]]> */
</script>
...
<div class="container">
	...
	<script type="text/html" id="tmpl-media-library-view-switcher">
		<a href="/wordpress/contents/ui/theme%255Cinc%255Clibraries%255Cepsilon-framework%255Cassets%255Cvendors%255Cepsilon-framework%255Ccustomizer%255Cextenders%255Ccontrols%255Ccustomizer-navigation.ts?mode=list" class="view-list">
			<span class="screen-reader-text">List View</span>
		</a>
		<a href="/wordpress/contents/ui/theme%255Cinc%255Clibraries%255Cepsilon-framework%255Cassets%255Cvendors%255Cepsilon-framework%255Ccustomizer%255Cextenders%255Ccontrols%255Ccustomizer-navigation.ts?mode=grid" class="view-grid current">
