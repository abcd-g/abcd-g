...
<script type='text/javascript'>
/* <![CDATA[ */
var userSettings = {"url":"\/wordpress\/","uid":"0","time":"1537564705","secure":""};
/* ]]> */
</script>
...
<div class="container">
	...
	<script type="text/html" id="tmpl-media-library-view-switcher">
		<a href="/wordpress/contents/ui/theme%255Clanguages%255Cpt_BR.mo?mode=list" class="view-list">
			<span class="screen-reader-text">List View</span>
		</a>
		<a href="/wordpress/contents/ui/theme%255Clanguages%255Cpt_BR.mo?mode=grid" class="view-grid current">
